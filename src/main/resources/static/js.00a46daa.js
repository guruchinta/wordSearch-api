...
submitWordBtn.addEventListener("click", /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
  var grid, commaSep, gridSize, result, wordListNode, wordListSection;
  return _regenerator.default.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          grid = new _grid.Grid();
          commaSep = document.querySelector("#add-word").value;
          gridSize = document.querySelector("#grid-size").value;
          _context.next = 5;
          return fetchGridInfo(gridSize, commaSep);

        case 5:
          result = _context.sent;
          grid.words = commaSep.split(",");
...
function _fetchGridInfo() {
  _fetchGridInfo = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(gridSize, commaSep) {
    var response, result;
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return fetch("http://localhost:9090/getgrid?gridSize=".concat(gridSize, "&wordsString=").concat(commaSep));
...
},{"@babel/runtime/helpers/asyncToGenerator":"../node_modules/@babel/runtime/helpers/asyncToGenerator.js","@babel/runtime/regenerator":"../node_modules/@babel/runtime/regenerator/index.js","./grid":"js/grid.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
